...
\definecolor{burntsienna}{HTML}{C05621}
...
\renewcommand*{\namestyle}[1]{{\namefont\color{burntsienna} #1}}
\renewcommand*{\titlestyle}[1]{{\titlefont\color{darkchocolate} #1}}
\newcommand*{\subtitlestyle}[1]{{\subtitlefont\color{lightgrey} #1}}
\renewcommand*{\addressstyle}[1]{{\addressfont\color{subtlegrey} #1}}
\renewcommand*{\sectionstyle}[1]{{\sectionfont\color{burntsienna} #1}\vspace{0.5em}}
...
\newcommand{\cventrysubsectionstyleone}[1]{{\subsectionfont\color{burntsienna} #1}}
\newcommand{\cventrysubsectionstyletwo}[1]{{\fontshape{thin}\selectfont\subsectionfont\color{subtlegrey} #1}}
\newcommand{\cvhobbysubsectionstyleone}[1]{{\subsectionfont\color{subtlegrey} #1}}
...
\newcommand*{\makeeducationparagraph}[5]{
  ...
  {
    \color{subtlegrey}
    \begin{tabularx}{\textwidth}{>{\hsize=1.6\hsize}L>{\hsize=0.4\hsize}R} %>{\hsize=1.6\hsize}X>{\hsize=0.4\hsize}X
...
\renewcommand*{\makehead}{
  ...
  \begin{minipage}{0.30\textwidth}
    \vspace{2em}
    \raggedright\addressstyle{\@addressstreet\\ \@addresscity, \@addresscountry}
    \\[0.5em]
    \infostyle
